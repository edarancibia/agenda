...
<div class="login">
    ...
    <form method="post" action="<?php echo base_url('index.php/Home/Main'); ?>">
    	<input type="text" name="email" placeholder="Username" required="required" />
        <input type="password" name="pass" placeholder="Password" required="required" />
        <button type="submit" class="btn btn-primary btn-block btn-large">Ingresar</button>
        <a href="<?php echo base_url('index.php/User'); ?>" class="btn btn-primary btn-block btn-large">Registrarse</a>
    </form>
</div>
